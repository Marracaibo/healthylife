...
# Lista ridotta di prodotti italiani da testare
ITALIAN_PRODUCTS = [
    "pasta al pomodoro",
    "pizza margherita",
    "risotto ai funghi",
...
async def test_edamam_italian_products():
    """Test dei prodotti italiani con Edamam"""
                ...
                if results["results"]:
                    ...
                    try:
                        ...
                        details = await asyncio.wait_for(
                            edamam_service.get_food(food_id),
                            timeout=10
                        )
                        details_time = time.time() - details_start
                        
                        if details:
                            logger.info(f"Dettagli ricevuti in {details_time:.2f} secondi:")
                            ...
                            logger.warning("Nessun dettaglio ricevuto")
...
if __name__ == "__main__":
    asyncio.run(test_edamam_italian_products())
