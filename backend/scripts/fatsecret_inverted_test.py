...
# FatSecret API credentials (invertite rispetto al precedente test)
CONSUMER_KEY = "ec9eca046ec44dd281a8c3c409211f7d"  # Invertito
CONSUMER_SECRET = "b187d2b15882439a80084b0e01b8c20f"  # Invertito
...
def test_search(query):
    try:
        print(f"\nRicerca per: '{query}' (con credenziali invertite)")
...
if __name__ == "__main__":
    print("===== Test di Ricerca FatSecret (Credenziali Invertite) =====")
    print("Questo script testa la ricerca con le credenziali invertite")
