...
import { CardioSkill, SkillProgression } from '../../types/cardioSkill';

interface CardioSkillDetailProps {
  skill: CardioSkill;
  onBack: () => void;
}

const CardioSkillDetail: React.FC<CardioSkillDetailProps> = ({ 
  skill, 
  onBack
}) => {
  ...
  function getExerciseIcon(exerciseName: string) {
    ...
    if (name.includes('run') || name.includes('corsa')) {
      return <Box component="img" src="/icons/running.png" alt="Running" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('swim') || name.includes('nuoto')) {
      return <Box component="img" src="/icons/swimming.png" alt="Swimming" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('bike') || name.includes('cycling') || name.includes('bici')) {
      return <Box component="img" src="/icons/cycling.png" alt="Cycling" sx={{ width: '24px', height: '24px' }} />;
      ...
      return <Box component="img" src="/icons/cardio.png" alt="Cardio" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('interval') || name.includes('hiit')) {
      return <Box component="img" src="/icons/hiit.png" alt="HIIT" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('ultra') || name.includes('marathon') || name.includes('maratona')) {
      return <Box component="img" src="/icons/endurance.png" alt="Marathon" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('ironman')) {
      return <Box component="img" src="/icons/triathlon.png" alt="Ironman" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('des sables')) {
      return <Box component="img" src="/icons/desert-run.png" alt="Marathon des Sables" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('antarctic') || name.includes('ice marathon')) {
      return <Box component="img" src="/icons/ice-marathon.png" alt="Antarctic Ice Marathon" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('endurance')) {
      return <Box component="img" src="/icons/endurance.png" alt="Endurance" sx={{ width: '24px', height: '24px' }} />;
    } else if (name.includes('sprint')) {
      return <Box component="img" src="/icons/sprint.png" alt="Sprint" sx={{ width: '24px', height: '24px' }} />;
    ...
    <Box>
      ...
      <Box 
        sx={{ 
          ...
          overflow: 'hidden',
          boxShadow: 3,
          background: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url(${skill.image || '/images/default-cardio.jpg'}) no-repeat center/cover`,
        }}
      >
                    ...
                    <Box>
                      ...
                      <Box sx={{ p: 3, bgcolor: alpha(theme.palette.background.default, 0.5) }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                          <DirectionsRun sx={{ mr: 1, color: theme.palette.text.secondary }} />
...
export default CardioSkillDetail;
